...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'adm.ditekjaya@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Admin Ditekjaya'; // Isikan dengan nama pengirim
    protected $password = 'adminditek'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->AddEmbeddedImage('public/image/logo.png', 'logo_mynotescode', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
        $send = $mail->send();
