    ...
    <div class="">
        ...
        <div class="clearfix"></div>
            <div class="row">
                ...
                ?>
                <form class="col-lg-12 col-md-12 col-sm-12" action="<?php echo base_url().'pendaftaran/update'?>" method="post">
                            ...
                            <div class="x_content">
                                ...
                                <div class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-8 col-sm-12 ">
                                            <textarea type="text" id="keluhan_pasien" name="keluhan_pasien"  class="form-control " required><?= $data['keluhan_pasien'] ?></textarea>
                                        </div>
                                    </div>
