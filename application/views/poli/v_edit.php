        ...
        <div class="clearfix"></div>
            <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo base_url().'poli/update'?>" method="post" class="form-horizontal form-label-left">

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Poli<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="nama_poli" name="nama_poli" value="<?= $data['nama_poli'] ?>" class="form-control" required="required">
                                    <input class="form-control" type="hidden" id="id_poli" name="id_poli" value="<?= $data['id_poli'] ?>" required>
