          ...
          <form action="<?php echo base_url().'admin/album/update'?>" method="post" enctype="multipart/form-data">
            <div class="tile-body">
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input class="form-control" type="text" id="album_title" name="album_title" value="<?= $data['album_title'] ?>" required>
                  <input class="form-control" type="hidden" id="id_album" name="id_album" value="<?= $data['id_album'] ?>" required>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-2">
                  <img src="<?= base_url()?>/public/image/upload/galeri_foto/<?= $data['album_cover'] ?>" style="width: 100px; height: 100px;">
                </div>
                <div class="col-md-4">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                    <h3>Foto Album</h3>
                    <button type="button" class="btn btn-info btn-sm icon-btn btnadd btn-pull-right btn_add_foto" id_album="<?= $data['id_album'] ?>"><i class="fa fa-plus"></i>Foto</button>
            ...
            <div class="tile-footer">
              <div class="form-group" style="margin-bottom: 20px;">
                <a href="<?= base_url();?>admin/album" class="btn btn-secondary" type="button" style="color: white;"><i class="fa fa-fw fa-lg fa-times-circle"></i>Batal</a>
