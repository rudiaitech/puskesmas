<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-th-list"></i> Edit Data Perusahaan</h1>
      <p><?= $dataperusahaan->nama_jenis ?> - <?= $dataperusahaan->nama_kategori ?></p>
    </div>
    </div>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="user-data">
            <div class="tile user-settings">
              ...
              <form action="<?php echo base_url().'admin/perusahaan/update'?>" method="post">
                <div class="form-group row">
                  <label class="control-label col-md-3">Nama Perusahaan</label>
                  <div class="col-md-5">
                    <input class="form-control" type="text" id="nama_perusahaan" name="nama_perusahaan" value="<?= $dataperusahaan->nama_perusahaan ?>">
                    <input class="form-control" type="hidden" id="id_perusahaan" name="id_perusahaan" value="<?= $id ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Alamat</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" id="alamat" name="alamat" value="<?= $dataperusahaan->alamat ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Koordinat</label>
                  <div class="col-md-6">
                    <input class="form-control" type="text" id="koordinat" name="koordinat" value="<?= $dataperusahaan->koordinat ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Spesifikasi Dermaga</label>
                  <div class="col-md-8">
                    <textarea class="form-control" rows="4" id="spesifikasi_dermaga" name="spesifikasi_dermaga"><?= $dataperusahaan->spesifikasi_dermaga ?></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Jarak Dermaga Terdekat</label>
                  <div class="col-md-4">
                    <input class="form-control" type="text" id="jarak_dermaga_terdekat" name="jarak_dermaga_terdekat" value="<?= $dataperusahaan->jarak_dermaga_terdekat ?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                    <input class="form-control" type="text" id="jarak_dermaga_pelindo" name="jarak_dermaga_pelindo" value="<?= $dataperusahaan->jarak_dermaga_pelindo ?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" id="luas_perairan" name="luas_perairan" value="<?= $dataperusahaan->luas_perairan ?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="<?= $dataperusahaan->nama_jenis ?>" readonly>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="<?= $dataperusahaan->nama_kategori ?>" readonly>
                    <input class="form-control" type="hidden" id="id_kategori" name="id_kategori" value="<?= $dataperusahaan->id_kategori ?>" readonly>
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  <div class="col-md-12">
                    <h3>Foto Dermaga</h3>
                    <button type="button" class="btn btn-info btn-sm icon-btn btnadd btn-pull-right btn_add_foto_dermaga" id_perusahaan="<?= $id ?>"><i class="fa fa-plus"></i>Foto Dermaga</button>
              ...
              <div class="tile">
                <div class="tile-body">
                  <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-info btn-sm icon-btn btnadd btn-pull-right btn_add_foto_layout" id_perusahaan="<?= $id ?>"><i class="fa fa-plus"></i>Layout dermaga</button>
              ...
              <div class="tile">
                <div class="tile-body">
                  <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-info btn-sm icon-btn btnadd btn-pull-right btn_add_foto_sarana" id_perusahaan="<?= $id ?>"><i class="fa fa-plus"></i>Sarana dan Prasarana</button>
            ...
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  <div class="col-md-12">
                    <h3>Perizinan</h3>
                    <button type="button" class="btn btn-info btn-sm icon-btn btnadd btn-pull-right btn_add_detail_perizinan" id_perusahaan="<?= $id ?>"><i class="fa fa-plus"></i>Perizinan</button>
