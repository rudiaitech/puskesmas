        ...
        <div class="clearfix"></div>
            <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo base_url().'pasien/insert'?>" method="post" class="form-horizontal form-label-left">

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">No Register<span class="required">*</span>
                                </label>
                                <div class="col-md-4 col-sm-12 ">
                                    <input type="text" id="noreg_pasien" name="noreg_pasien" required="required" class="form-control ">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <input type="text" id="nikktp_pasien" name="nikktp_pasien" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <input type="text" id="nama_pasien" name="nama_pasien" required="required" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="alamat_pasien" name="alamat_pasien" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-4 col-sm-12 ">
                                    <input type="date" id="tanggallahir_pasien" name="tanggallahir_pasien" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-4 col-sm-12 ">
                                    <input type="text" id="tempatlahir_pasien" name="tempatlahir_pasien" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-4 col-sm-12 ">
                                    <input type="text" id="notlp_pasien" name="notlp_pasien" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <input type="text" id="nojamkes_pasien" name="nojamkes_pasien"  class="form-control ">
                                </div>
                            </div>
