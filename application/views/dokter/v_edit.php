        ...
        <div class="clearfix"></div>
            <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo base_url().'dokter/update'?>" method="post" class="form-horizontal form-label-left">

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">NK Dokter<span class="required">*</span>
                                </label>
                                <div class="col-md-4 col-sm-12 ">
                                    <input type="text" id="nik_dokter" name="nik_dokter" required="required" class="form-control " value="<?= $data['nik_dokter'] ?>">
                                    <input type="hidden" id="id_dokter" name="id_dokter" required="required" class="form-control" value="<?= $data['id_dokter'] ?>">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <input type="text" id="nama_dokter" name="nama_dokter" required="required" class="form-control " value="<?= $data['nama_dokter'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <input type="text" id="inisial_dokter" name="inisial_dokter" required="required" class="form-control " maxlength="3" value="<?= $data['inisial_dokter'] ?>">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="alamat_dokter" name="alamat_dokter" required="required" class="form-control " value="<?= $data['alamat_dokter'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-4 col-sm-12 ">
                                    <input type="text" id="notlp_dokter" name="notlp_dokter" required="required" class="form-control " value="<?= $data['notlp_dokter'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <input type="text" id="username_dokter" name="username_dokter" required="required" class="form-control " value="<?= $data['username_dokter'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <input type="text" id="password_dokter" name="password_dokter"  class="form-control ">
                                    <span style="color: red;">Kosongkan kolom ini jika tidak ingin mengganti password</span>
                                </div>
                            </div>
